...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/CSS_ADM_FAC/menu_f.css">
                        ...
                        <?php if (($busqueda = $_GET['buscarFactura']) != '') { ?>
                            ...
                            <?php while ($row = $consulta->fetch_array()) { ?>
                                <tr>
                                    ...
                                    <td><?php $feI = explode(" ", $row['fecha_ini']);
                                        echo $feI[0]; ?></td>
                                    <td><?php $feF = explode(" ", $row['fecha_fin']);
                                        echo $feF[0]; ?></td>
                                    <td><?php if ($row['estado_plan'] == 0) {
                                            echo "Activado";
                                        }
