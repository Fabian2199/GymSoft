...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/css_ent_index/menu.css">
  <link rel="stylesheet" type="text/css" href="../../iconos/web-fonts-with-css/css/fontawesome-all.css">
  <link rel="stylesheet" type="text/css" href="../Css/CSS_ENT_INDEx/principal_ent_clt.css">
  <link rel="stylesheet" type="text/css" href="../Css/CSS_ENT_INDEx/principal_ent_clt_taR.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
  <title>Ficha AP</title>

  <link rel="stylesheet" href="../css/CSS_FICHA/nicepage.css" media="screen">
  <link rel="stylesheet" href="../css/CSS_FICHA/Page-3.css" media="screen">
...
<body data-home-page="Page-3.html" data-home-page-title="Page 3" class="u-body u-xl-mode">
        ...
        <div class="u-expanded-width u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-30 u-form-vertical u-inner-form" style="padding: 0;" name="form">
            ...
            <div class="u-align-left u-form-group  u-form-group-42">
              <a href="ent_index.php" class="boton">Regresar</a>
              <input type="submit" onclick="pregunta()" name="register" class="registrar u-btn u-btn-submit u-button-style u-hover-grey-25 u-white u-btn-1" id="registrar" />
            </div>
          </form>
  ...
  <div type="hidden" class="registerficha">
    <?php
    error_reporting(0);
    include("../php/reg_ficha.php");
    ?>
  </div>


  <footer class="u-clearfix u-footer u-grey-80" id="sec-d26a">
    <div class="u-clearfix u-sheet u-sheet-1">
      <div class="u-align-left u-social-icons u-spacing-10 u-social-icons-1">
        <a class="u-social-url" title="facebook" target="_blank" href=""><span class="u-icon u-social-facebook u-social-icon u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-f24d"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-f24d">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
              <path fill="#FFFFFF" d="M73.5,31.6h-9.1c-1.4,0-3.6,0.8-3.6,3.9v8.5h12.6L72,58.3H60.8v40.8H43.9V58.3h-8V43.9h8v-9.2
            c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"></path>
            </svg></span>
        </a>
        <a class="u-social-url" title="instagram" target="_blank" href=""><span class="u-icon u-social-icon u-social-instagram u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-2d0e"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-2d0e">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
...
<script language="JavaScript">
  function pregunta() {
    if (alert('¡Formulario registrado con exito!')) {
